        ...
        describe(`decimals permutation: ${decimals}`, () => {
            ...
            test('Token', () => {
                tokens = ADDRESSES.map(
                    (address, i) => new Token({ chainId: CHAIN_ID, address: address, decimals: decimals[i] })
                )
            ...
            test('Price:Route.midPrice', () => {
                invariant(!route.input.isNative)
                invariant(!route.output.isNative)
                ...
                expect(
                    route.midPrice
                        .invert()
                        .quote(new TokenAmount(route.output, decimalize(1234, route.output.decimals)))
            ...
            describe.skip('Trade', () => {
                ...
                test('minimum TradeType.EXACT_INPUT', () => {
            ...
            test('TokenAmount', () => {
                ...
                expect(amount.toExact(4, { groupSeparator: ',' })).toEqual('1,234.567')
            })
        })
    })
})
