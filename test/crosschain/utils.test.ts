...
import { calculateGasMargin, getMinAmount, patchCalldata, splitSlippage, Token, TokenAmount } from '../../src'
import { BigNumber } from 'ethers'

describe('#patchCalldata', () => {
    test('ok', () => {
        const data =
        ...
        const offset = 100
        const newAmount = new TokenAmount(new Token({ chainId: 1, address: '', decimals: 18 }), '1000000000000000000')
        const newData = patchCalldata(data, offset, newAmount)
