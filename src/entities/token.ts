...
export const WETH = {
    ...
    [ChainId.XLM_MAINNET]: new Token({ chainId: ChainId.XLM_MAINNET, address: '', decimals: 7 }),
    [ChainId.XRP_MAINNET]: new Token({ chainId: ChainId.XRP_MAINNET, address: '', decimals: 6 }),
    [ChainId.XMR_MAINNET]: new Token({ chainId: ChainId.XMR_MAINNET, address: '', decimals: 12 }),
    [ChainId.ADA_MAINNET]: new Token({ chainId: ChainId.ADA_MAINNET, address: '', decimals: 6 }),
    [ChainId.BCH_MAINNET]: new Token({ chainId: ChainId.BCH_MAINNET, address: '', decimals: 8 }),
    [ChainId.SUI_MAINNET]: new Token({ chainId: ChainId.SUI_MAINNET, address: '', decimals: 9 }),
