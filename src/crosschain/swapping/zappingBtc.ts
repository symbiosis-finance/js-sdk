...
import { MulticallRouter, Synthesis } from '../contracts/index.ts'
import { OneInchProtocols } from '../trade/oneInchTrade.ts'
import { initEccLib } from 'bitcoinjs-lib'
import ecc from '@bitcoinerlab/secp256k1'
import { getPkScript, getThreshold, getToBtcFee } from '../chainUtils/btc.ts'
import { Address, EvmAddress, FeeItem, MultiCallItem, SwapExactInResult } from '../types.ts'
import { isEvmChainId } from '../chainUtils/index.ts'
...
import { AmountLessThanFeeError, AmountTooLowError, SdkError } from '../sdkError.ts'
