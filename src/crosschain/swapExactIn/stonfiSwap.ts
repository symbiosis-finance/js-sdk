...
export function stonfiSwap(params: SwapExactInParams): Promise<SwapExactInResult> {
    return withSpan('stonfiSwap', {}, async () => {
        const { symbiosis, tokenAmountIn, tokenOut, from, to, slippage, deadline } = params
