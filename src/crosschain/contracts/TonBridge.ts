...
export interface ChangeBridgeChainIdEventObject {
    newBridgeChainId: BigNumber
}
export type ChangeBridgeChainIdEvent = TypedEvent<[BigNumber], ChangeBridgeChainIdEventObject>

export type ChangeBridgeChainIdEventFilter = TypedEventFilter<ChangeBridgeChainIdEvent>

export interface ChangeBroadcasterEventObject {
    newBroadcaster: string
}
export type ChangeBroadcasterEvent = TypedEvent<[string], ChangeBroadcasterEventObject>

export type ChangeBroadcasterEventFilter = TypedEventFilter<ChangeBroadcasterEvent>

export interface ChangeSymbiosisBridgeEventObject {
    newBridge: string
}
export type ChangeSymbiosisBridgeEvent = TypedEvent<[string], ChangeSymbiosisBridgeEventObject>

export type ChangeSymbiosisBridgeEventFilter = TypedEventFilter<ChangeSymbiosisBridgeEvent>

export interface ChangeTonBridgeEventObject {
    newBridge: string
}
export type ChangeTonBridgeEvent = TypedEvent<[string], ChangeTonBridgeEventObject>
...
export interface TonBridge extends BaseContract {
    ...
    functions: {
        ...
        changeTonBridge(_newTonBridge: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    changeBroadcaster(_newBroadcaster: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    estimateGas: {
        ...
        changeBroadcaster(_newBroadcaster: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
        ...
        changeTonBridge(_newTonBridge: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    populateTransaction: {
        ...
        changeTonBridge(_newTonBridge: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
