...
export interface BridgeV2NonEvmInterface extends utils.Interface {
    ...
    functions: {
        ...
        'transmitRequestV2(bytes,bytes,bytes,uint256)': FunctionFragment
    ...
    events: {
        ...
        'OracleRequest(address,bytes,bytes,bytes,uint256)': EventFragment
...
export interface BridgeV2NonEvm extends BaseContract {
    ...
    filters: {
        ...
        'OracleRequest(address,bytes,bytes,bytes,uint256)'(
            bridge?: null,
            callData?: null,
            receiveSide?: null,
            oppositeBridge?: null,
