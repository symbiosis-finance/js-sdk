...
export declare namespace TonUtils {
  ...
  export type TonTxIDStructOutput = [
    TonUtils.TonAddressStructOutput,
    string,
    BigNumber
  ] & {
  ...
  export type SwapDataStructOutput = [
    string,
    BigNumber,
    TonUtils.TonTxIDStructOutput
  ] & { receiver: string; amount: BigNumber; tx: TonUtils.TonTxIDStructOutput };
}
...
export interface WTONInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, TonUtils.TonAddressStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "burnFrom",
    values: [string, BigNumberish, TonUtils.TonAddressStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "checkSignature",
    values: [BytesLike, TonUtils.SignatureStruct]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "finishedVotings",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "getFullOracleSet",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getNewBurnStatusId",
    values: [boolean, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getNewSetId",
    values: [BigNumberish, string[]]
  ): string;
  encodeFunctionData(
    functionFragment: "getSwapDataId",
    values: [TonUtils.SwapDataStruct]
  ): string;
  encodeFunctionData(
...
export type NewOracleSetEvent = TypedEvent<
  [BigNumber, string[]],
  { oracleSetHash: BigNumber; newOracles: string[] }
>;
...
export interface WTON extends BaseContract {
  ...
  filters: {
    ...
    "NewOracleSet(int256,address[])"(
      oracleSetHash?: null,
      newOracles?: null
    ): NewOracleSetEventFilter;
    NewOracleSet(
      oracleSetHash?: null,
      newOracles?: null
    ): NewOracleSetEventFilter;
