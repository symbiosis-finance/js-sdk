...
export interface UniV3Router02Interface extends utils.Interface {
    functions: {
...
export interface UniV3Router02 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this
    attach(addressOrName: string): this
    deployed(): Promise<this>

    interface: UniV3Router02Interface
    ...
    functions: {
        ...
        approveMax(token: string, overrides?: PayableOverrides & { from?: string }): Promise<ContractTransaction>
        ...
        wrapETH(value: BigNumberish, overrides?: PayableOverrides & { from?: string }): Promise<ContractTransaction>
    }
    ...
    approveMaxMinusOne(token: string, overrides?: PayableOverrides & { from?: string }): Promise<ContractTransaction>

    approveZeroThenMax(token: string, overrides?: PayableOverrides & { from?: string }): Promise<ContractTransaction>
    ...
    callPositionManager(data: BytesLike, overrides?: PayableOverrides & { from?: string }): Promise<ContractTransaction>
    ...
    estimateGas: {
        ...
        approveMax(token: string, overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>

        approveMaxMinusOne(token: string, overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>

        approveZeroThenMax(token: string, overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>

        approveZeroThenMaxMinusOne(token: string, overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>

        callPositionManager(data: BytesLike, overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>
        ...
        'multicall(bytes[])'(data: BytesLike[], overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>

        positionManager(overrides?: CallOverrides): Promise<BigNumber>

        pull(token: string, value: BigNumberish, overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>
        ...
        wrapETH(value: BigNumberish, overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>
    }

    populateTransaction: {
        WETH9(overrides?: CallOverrides): Promise<PopulatedTransaction>

        approveMax(token: string, overrides?: PayableOverrides & { from?: string }): Promise<PopulatedTransaction>
        ...
        wrapETH(value: BigNumberish, overrides?: PayableOverrides & { from?: string }): Promise<PopulatedTransaction>
    }
}
