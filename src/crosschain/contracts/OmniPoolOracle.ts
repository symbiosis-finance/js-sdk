...
export interface OmniPoolOracle extends BaseContract {
    ...
    functions: {
        ...
        initialize(_pool: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    estimateGas: {
        ...
        initialize(_pool: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    populateTransaction: {
        ...
        initialize(_pool: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
