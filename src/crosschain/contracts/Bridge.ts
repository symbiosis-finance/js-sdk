...
export type LogChangeMPCEvent = TypedEvent<[string, string, BigNumber, BigNumber], LogChangeMPCEventObject>
...
export type OracleRequestEvent = TypedEvent<[string, string, string, string, BigNumber], OracleRequestEventObject>
...
export type SetAdminPermissionEvent = TypedEvent<[string, boolean], SetAdminPermissionEventObject>
...
export type SetTransmitterStatusEvent = TypedEvent<[string, boolean], SetTransmitterStatusEventObject>
...
export interface Bridge extends BaseContract {
    ...
    functions: {
        changeMPC(_newMPC: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
        ...
        initialize(_mpc: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    estimateGas: {
        changeMPC(_newMPC: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
        ...
        initialize(_mpc: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    populateTransaction: {
        changeMPC(_newMPC: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
        ...
        initialize(_mpc: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
