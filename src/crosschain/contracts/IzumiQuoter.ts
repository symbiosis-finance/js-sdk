...
export interface IzumiQuoterInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'swapAmount', values: [BigNumberish, BytesLike]): string
    encodeFunctionData(functionFragment: 'swapDesire', values: [BigNumberish, BytesLike]): string
    encodeFunctionData(
...
export interface IzumiQuoter extends BaseContract {
    ...
    functions: {
        ...
        swapX2YCallback(x: BigNumberish, y: BigNumberish, path: BytesLike, overrides?: CallOverrides): Promise<[void]>
        ...
        swapY2XCallback(x: BigNumberish, y: BigNumberish, path: BytesLike, overrides?: CallOverrides): Promise<[void]>
    ...
    callStatic: {
        ...
        ): Promise<[BigNumber, number[]] & { acquire: BigNumber; pointAfterList: number[] }>

        swapDesire(
            desire: BigNumberish,
            path: BytesLike,
            overrides?: CallOverrides
        ): Promise<[BigNumber, number[]] & { cost: BigNumber; pointAfterList: number[] }>
    ...
    estimateGas: {
        ...
        swapAmount(amount: BigNumberish, path: BytesLike, overrides?: Overrides & { from?: string }): Promise<BigNumber>

        swapDesire(desire: BigNumberish, path: BytesLike, overrides?: Overrides & { from?: string }): Promise<BigNumber>
