...
export type MetaRevertRequestEvent = TypedEvent<[string, string], MetaRevertRequestEventObject>
...
export type RevertBurnRequestEvent = TypedEvent<[string, string], RevertBurnRequestEventObject>
...
export type SetWhitelistTokenEvent = TypedEvent<[string, boolean], SetWhitelistTokenEventObject>
