...
export interface IzumiSwap extends BaseContract {
    ...
    functions: {
        ...
        refundETH(overrides?: PayableOverrides & { from?: string }): Promise<ContractTransaction>
    ...
    estimateGas: {
        ...
        refundETH(overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>
        ...
        swapX2Y(swapParams: Swap.SwapParamsStruct, overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>
        ...
        swapY2X(swapParams: Swap.SwapParamsStruct, overrides?: PayableOverrides & { from?: string }): Promise<BigNumber>
    ...
    populateTransaction: {
        ...
        refundETH(overrides?: PayableOverrides & { from?: string }): Promise<PopulatedTransaction>
