...
export interface ChainFlipVaultInterface extends utils.Interface {
    contractName: 'ChainFlipVault'
    functions: {
        ...
        'allBatchV2((uint256,uint256,address),(address,address)[],(address,address,uint256)[])': FunctionFragment
        ...
        'transferFallback((uint256,uint256,address),(address,address,uint256))': FunctionFragment
    ...
    encodeFunctionData(functionFragment: 'addGasNative', values: [BytesLike]): string
    encodeFunctionData(functionFragment: 'addGasToken', values: [BytesLike, BigNumberish, string]): string
    encodeFunctionData(
    ...
    encodeFunctionData(
        functionFragment: 'allBatchV2',
        values: [IShared.SigDataStruct, IShared.FetchParamsStruct[], IShared.TransferParamsStruct[]]
    ): string
    encodeFunctionData(
        functionFragment: 'deployAndFetchBatch',
        values: [IShared.SigDataStruct, IShared.DeployFetchParamsStruct[]]
    ): string
    encodeFunctionData(functionFragment: 'disableCommunityGuard', values?: undefined): string
    encodeFunctionData(functionFragment: 'enableCommunityGuard', values?: undefined): string
    encodeFunctionData(
        functionFragment: 'executeActions',
        values: [IShared.SigDataStruct, IShared.TransferParamsStruct, IMulticall.CallStruct[], BigNumberish]
    ): string
    encodeFunctionData(
    ...
    encodeFunctionData(
        ...
        values: [IShared.SigDataStruct, IShared.TransferParamsStruct, BigNumberish, BytesLike, BytesLike]
    ): string
    encodeFunctionData(
        functionFragment: 'fetchBatch',
        values: [IShared.SigDataStruct, IShared.FetchParamsStruct[]]
    ): string
    encodeFunctionData(functionFragment: 'getCommunityGuardDisabled', values?: undefined): string
    encodeFunctionData(functionFragment: 'getCommunityKey', values?: undefined): string
    encodeFunctionData(functionFragment: 'getGovernor', values?: undefined): string
    encodeFunctionData(functionFragment: 'getKeyManager', values?: undefined): string
    encodeFunctionData(functionFragment: 'getSuspendedState', values?: undefined): string
    encodeFunctionData(functionFragment: 'govWithdraw', values: [string[]]): string
    ...
    encodeFunctionData(
        functionFragment: 'transferFallback',
        values: [IShared.SigDataStruct, IShared.TransferParamsStruct]
    ): string
    encodeFunctionData(functionFragment: 'updateKeyManager', values: [IShared.SigDataStruct, string, boolean]): string
    encodeFunctionData(
        functionFragment: 'xCallNative',
        values: [BigNumberish, BytesLike, BigNumberish, BytesLike, BigNumberish, BytesLike]
    ): string
    encodeFunctionData(
        functionFragment: 'xCallToken',
        values: [BigNumberish, BytesLike, BigNumberish, BytesLike, BigNumberish, string, BigNumberish, BytesLike]
    ): string
    encodeFunctionData(
    ...
    encodeFunctionData(
        ...
        values: [BigNumberish, BytesLike, BigNumberish, string, BigNumberish, BytesLike]
    ): string

    decodeFunctionResult(functionFragment: 'addGasNative', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'addGasToken', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'allBatch', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'allBatchV2', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'deployAndFetchBatch', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'disableCommunityGuard', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'enableCommunityGuard', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'executeActions', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'executexCall', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'executexSwapAndCall', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'fetchBatch', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'getCommunityGuardDisabled', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'getCommunityKey', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'getGovernor', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'getKeyManager', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'getSuspendedState', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'govWithdraw', data: BytesLike): Result
    ...
    decodeFunctionResult(functionFragment: 'transferFallback', data: BytesLike): Result
    decodeFunctionResult(functionFragment: 'updateKeyManager', data: BytesLike): Result
    ...
    events: {
        ...
        'FetchedNative(address,uint256)': EventFragment
    ...
    getEvent(nameOrSignatureOrTopic: 'FetchedNative'): EventFragment
...
export type AddGasNativeEvent = TypedEvent<[string, BigNumber], { swapID: string; amount: BigNumber }>

export type AddGasNativeEventFilter = TypedEventFilter<AddGasNativeEvent>

export type AddGasTokenEvent = TypedEvent<
    [string, BigNumber, string],
    { swapID: string; amount: BigNumber; token: string }
>

export type AddGasTokenEventFilter = TypedEventFilter<AddGasTokenEvent>

export type CommunityGuardDisabledEvent = TypedEvent<[boolean], { communityGuardDisabled: boolean }>

export type CommunityGuardDisabledEventFilter = TypedEventFilter<CommunityGuardDisabledEvent>

export type ExecuteActionsFailedEvent = TypedEvent<
    [string, BigNumber, string, string],
    { multicallAddress: string; amount: BigNumber; token: string; reason: string }
>

export type ExecuteActionsFailedEventFilter = TypedEventFilter<ExecuteActionsFailedEvent>

export type FetchedNativeEvent = TypedEvent<[string, BigNumber], { sender: string; amount: BigNumber }>

export type FetchedNativeEventFilter = TypedEventFilter<FetchedNativeEvent>

export type SuspendedEvent = TypedEvent<[boolean], { suspended: boolean }>
...
export type TransferNativeFailedEvent = TypedEvent<[string, BigNumber], { recipient: string; amount: BigNumber }>

export type TransferNativeFailedEventFilter = TypedEventFilter<TransferNativeFailedEvent>

export type TransferTokenFailedEvent = TypedEvent<
    [string, BigNumber, string, string],
    { recipient: string; amount: BigNumber; token: string; reason: string }
>

export type TransferTokenFailedEventFilter = TypedEventFilter<TransferTokenFailedEvent>

export type UpdatedKeyManagerEvent = TypedEvent<[string], { keyManager: string }>

export type UpdatedKeyManagerEventFilter = TypedEventFilter<UpdatedKeyManagerEvent>
...
export type XCallTokenEvent = TypedEvent<
    [number, string, number, string, BigNumber, string, string, BigNumber, string],
    {
        dstChain: number
        dstAddress: string
        dstToken: number
...
export interface ChainFlipVault extends BaseContract {
    contractName: 'ChainFlipVault'
    connect(signerOrProvider: Signer | Provider | string): this
    attach(addressOrName: string): this
    deployed(): Promise<this>

    interface: ChainFlipVaultInterface
    ...
    functions: {
        ...
        disableCommunityGuard(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>

        enableCommunityGuard(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>
        ...
        suspend(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>
    ...
    callStatic: {
        ...
        addGasToken(swapID: BytesLike, amount: BigNumberish, token: string, overrides?: CallOverrides): Promise<void>
    ...
    filters: {
        'AddGasNative(bytes32,uint256)'(swapID?: null, amount?: null): AddGasNativeEventFilter
        AddGasNative(swapID?: null, amount?: null): AddGasNativeEventFilter

        'AddGasToken(bytes32,uint256,address)'(swapID?: null, amount?: null, token?: null): AddGasTokenEventFilter
        AddGasToken(swapID?: null, amount?: null, token?: null): AddGasTokenEventFilter

        'CommunityGuardDisabled(bool)'(communityGuardDisabled?: null): CommunityGuardDisabledEventFilter
        CommunityGuardDisabled(communityGuardDisabled?: null): CommunityGuardDisabledEventFilter
        ...
        'FetchedNative(address,uint256)'(sender?: string | null, amount?: null): FetchedNativeEventFilter
        FetchedNative(sender?: string | null, amount?: null): FetchedNativeEventFilter
        ...
        TransferNativeFailed(recipient?: string | null, amount?: null): TransferNativeFailedEventFilter
        ...
        'UpdatedKeyManager(address)'(keyManager?: null): UpdatedKeyManagerEventFilter
    ...
    estimateGas: {
        ...
        disableCommunityGuard(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>

        enableCommunityGuard(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
        ...
        govWithdraw(tokens: string[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>

        resume(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>

        suspend(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
    ...
    populateTransaction: {
        ...
        enableCommunityGuard(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>
        ...
        getCommunityGuardDisabled(overrides?: CallOverrides): Promise<PopulatedTransaction>
        ...
        suspend(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>
