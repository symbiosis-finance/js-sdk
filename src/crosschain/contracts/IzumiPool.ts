...
export interface AddLimitOrderEventObject {
    amount: BigNumber
    point: number
    sellXEarnY: boolean
}
export type AddLimitOrderEvent = TypedEvent<[BigNumber, number, boolean], AddLimitOrderEventObject>
...
export interface DecLimitOrderEventObject {
    amount: BigNumber
    point: number
    sellXEarnY: boolean
}
export type DecLimitOrderEvent = TypedEvent<[BigNumber, number, boolean], DecLimitOrderEventObject>
...
export type SwapEvent = TypedEvent<[string, string, number, boolean, BigNumber, BigNumber], SwapEventObject>
...
export interface IzumiPool extends BaseContract {
    ...
    functions: {
        ...
        collectFeeCharged(overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    estimateGas: {
        ...
        collectFeeCharged(overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    populateTransaction: {
        ...
        collectFeeCharged(overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
