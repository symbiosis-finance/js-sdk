...
export type ClaimedTokensEvent = TypedEvent<[string, BigNumber], ClaimedTokensEventObject>
...
export type FeeCollectedEvent = TypedEvent<[string, BigNumber, BigNumber], FeeCollectedEventObject>
...
export interface OctoPoolFeeCollector extends BaseContract {
    ...
    functions: {
        ...
        setFeeReceiver(_newFeeReceiver: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    changeFeeRate(_newFeeRate: BigNumberish, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    estimateGas: {
        ...
        changeFeeRate(_newFeeRate: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>

        collectFee(amount: BigNumberish, token: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
        ...
        setFeeReceiver(_newFeeReceiver: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
