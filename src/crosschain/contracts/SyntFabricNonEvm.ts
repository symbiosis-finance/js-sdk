...
export interface SyntFabricNonEvmInterface extends utils.Interface {
    contractName: 'SyntFabricNonEvm'
    functions: {
        'createRepresentationByAdmin(bytes32,uint256,string,string,uint8)': FunctionFragment
        'getRealRepresentation(address)': FunctionFragment
        'getSyntRepresentation(bytes32,uint256)': FunctionFragment
    ...
    encodeFunctionData(functionFragment: 'getSyntRepresentation', values: [BytesLike, BigNumberish]): string
    ...
    events: {
        ...
        'RepresentationCreated(bytes32,uint256,address)': EventFragment
    }
...
export interface SyntFabricNonEvm extends BaseContract {
    contractName: 'SyntFabricNonEvm'
    connect(signerOrProvider: Signer | Provider | string): this
    attach(addressOrName: string): this
    deployed(): Promise<this>

    interface: SyntFabricNonEvmInterface
    ...
    getSyntRepresentation(_realTokenAdr: BytesLike, _chainID: BigNumberish, overrides?: CallOverrides): Promise<string>
    ...
    filters: {
        ...
        'RepresentationCreated(bytes32,uint256,address)'(
            rToken?: null,
            chainID?: null,
            sToken?: null
