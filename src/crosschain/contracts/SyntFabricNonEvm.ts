...
export interface SyntFabricNonEvmInterface extends utils.Interface {
    ...
    functions: {
        'createRepresentationByAdmin(bytes,uint256,string,string,uint8)': FunctionFragment
        'getRealRepresentation(address)': FunctionFragment
        'getSyntRepresentation(bytes,uint256)': FunctionFragment
    ...
    events: {
        ...
        'RepresentationCreated(bytes,uint256,address)': EventFragment
    }
...
export interface SyntFabricNonEvm extends BaseContract {
    ...
    filters: {
        ...
        'RepresentationCreated(bytes,uint256,address)'(
            rToken?: null,
            chainID?: null,
            sToken?: null
