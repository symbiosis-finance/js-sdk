...
export type NewPoolEvent = TypedEvent<[string, string, number, number, string], NewPoolEventObject>
...
export interface IzumiFactory extends BaseContract {
    ...
    estimateGas: {
        ...
        modifyChargeReceiver(_chargeReceiver: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
