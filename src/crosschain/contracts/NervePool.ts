...
export type NewDepositFeeEvent = TypedEvent<[BigNumber], { newDepositFee: BigNumber }>
...
export type NewWithdrawFeeEvent = TypedEvent<[BigNumber], { newWithdrawFee: BigNumber }>
...
export interface NervePool extends BaseContract {
    ...
    functions: {
        ...
        swapStorage(overrides?: CallOverrides): Promise<
            [BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, string, string] & {
                initialA: BigNumber
                futureA: BigNumber
