...
export declare namespace TimedSwapUnlocker {
...
export interface TimedSwapUnlockerInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [TimedSwapUnlocker.ConditionStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "encodeSolution",
    values: [TimedSwapUnlocker.SolutionStruct]
  ): string;
  encodeFunctionData(
...
export interface TimedSwapUnlocker extends BaseContract {
  ...
  interface: TimedSwapUnlockerInterface;
  ...
  functions: {
    ...
    ): Promise<[TimedSwapUnlocker.ConditionStructOutput]>;

    encodeCondition(
      c: TimedSwapUnlocker.ConditionStruct,
      overrides?: CallOverrides
    ): Promise<[string]>;

    encodeSolution(
      s: TimedSwapUnlocker.SolutionStruct,
      overrides?: CallOverrides
    ): Promise<[string]>;
