...
export interface BtcRefundUnlockerInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [BtcRefundUnlocker.ConditionStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "encodeSolution",
    values: [BtcRefundUnlocker.SolutionStruct]
  ): string;
...
export type RefundEvent = TypedEvent<
  [string, BigNumber],
  { refundAddress: string; stableBridgingFee: BigNumber }
>;
...
export interface BtcRefundUnlocker extends BaseContract {
  ...
  functions: {
    ...
    encodeCondition(
      c: BtcRefundUnlocker.ConditionStruct,
      overrides?: CallOverrides
    ): Promise<[string]>;

    encodeSolution(
      s: BtcRefundUnlocker.SolutionStruct,
      overrides?: CallOverrides
    ): Promise<[string]>;
