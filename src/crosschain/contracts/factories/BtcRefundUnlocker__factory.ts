...
import type { BtcRefundUnlocker, BtcRefundUnlockerInterface } from '../BtcRefundUnlocker.js'
...
export class BtcRefundUnlocker__factory extends ContractFactory {
    ...
    override deploy(_synthesis: string, overrides?: Overrides & { from?: string }): Promise<BtcRefundUnlocker> {
        return super.deploy(_synthesis, overrides || {}) as Promise<BtcRefundUnlocker>
    }
    override getDeployTransaction(_synthesis: string, overrides?: Overrides & { from?: string }): TransactionRequest {
        return super.getDeployTransaction(_synthesis, overrides || {})
    }
    override attach(address: string): BtcRefundUnlocker {
        return super.attach(address) as BtcRefundUnlocker
    }
    override connect(signer: Signer): BtcRefundUnlocker__factory {
