...
import type { BranchedUnlocker, BranchedUnlockerInterface } from '../BranchedUnlocker.js'
...
export class BranchedUnlocker__factory extends ContractFactory {
    ...
    override deploy(overrides?: Overrides & { from?: string }): Promise<BranchedUnlocker> {
    ...
    override attach(address: string): BranchedUnlocker {
        return super.attach(address) as BranchedUnlocker
    }
    override connect(signer: Signer): BranchedUnlocker__factory {
