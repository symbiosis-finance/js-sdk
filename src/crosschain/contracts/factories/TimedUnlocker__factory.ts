...
import type { TimedUnlocker, TimedUnlockerInterface } from '../TimedUnlocker.js'
...
export class TimedUnlocker__factory extends ContractFactory {
    ...
    override deploy(overrides?: Overrides & { from?: string }): Promise<TimedUnlocker> {
    ...
    override attach(address: string): TimedUnlocker {
        return super.attach(address) as TimedUnlocker
    }
    override connect(signer: Signer): TimedUnlocker__factory {
