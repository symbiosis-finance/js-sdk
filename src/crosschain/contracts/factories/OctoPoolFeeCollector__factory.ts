...
import type { OctoPoolFeeCollector, OctoPoolFeeCollectorInterface } from '../OctoPoolFeeCollector.js'
...
export class OctoPoolFeeCollector__factory extends ContractFactory {
    ...
    override attach(address: string): OctoPoolFeeCollector {
        return super.attach(address) as OctoPoolFeeCollector
    }
    override connect(signer: Signer): OctoPoolFeeCollector__factory {
