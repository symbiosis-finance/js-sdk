...
import type {
  OctoPoolFeeCollector,
  OctoPoolFeeCollectorInterface,
} from "../OctoPoolFeeCollector";
...
type OctoPoolFeeCollectorConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: OctoPoolFeeCollectorConstructorParams
...
export class OctoPoolFeeCollector__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(
      ...
      _feeRate,
      overrides || {}
    ) as Promise<OctoPoolFeeCollector>;
  }
