...
import type { Ooki, OokiInterface } from '../Ooki'
...
export class Ooki__factory {
    static readonly abi = _abi
    static createInterface(): OokiInterface {
        return new utils.Interface(_abi) as OokiInterface
    }
    static connect(address: string, signerOrProvider: Signer | Provider): Ooki {
        return new Contract(address, _abi, signerOrProvider) as Ooki
    }
}
