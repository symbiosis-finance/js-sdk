...
import type { SyncSwapLaunchPool, SyncSwapLaunchPoolInterface } from '../SyncSwapLaunchPool'
...
export class SyncSwapLaunchPool__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): SyncSwapLaunchPool {
