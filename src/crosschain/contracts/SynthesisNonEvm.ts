...
export interface SynthesisNonEvmInterface extends utils.Interface {
    ...
    functions: {
        ...
        'burnSyntheticToken(uint256,address,uint256,bytes,bytes,bytes,bytes,uint256,bytes32)': FunctionFragment
        'fabric()': FunctionFragment
        'initialize(address,address,address)': FunctionFragment
        'isTrustedForwarder(address)': FunctionFragment
        'metaBurnSyntheticToken((uint256,uint256,address,bytes,address,bytes,uint256,bytes,bytes,bytes,bytes,uint256,bytes32))': FunctionFragment
        'metaMintSyntheticToken((uint256,uint256,bytes32,bytes,uint256,address,address[],address,bytes,address,bytes,uint256))': FunctionFragment
        'metaRouter()': FunctionFragment
        'mintSyntheticToken(uint256,bytes32,bytes,uint256,uint256,address)': FunctionFragment
        ...
        'revertSynthesizeRequest(uint256,bytes32,bytes,bytes,uint256,bytes32)': FunctionFragment
    ...
    encodeFunctionData(
        ...
        values: [BigNumberish, BytesLike, BytesLike, BytesLike, BigNumberish, BytesLike]
    ): string
    ...
    events: {
        'BurnRequest(bytes32,address,uint256,bytes,bytes,uint256,address)': EventFragment
        ...
        'SynthesizeCompleted(bytes32,address,uint256,uint256,bytes)': EventFragment
...
export interface SynthesisNonEvm extends BaseContract {
    ...
    filters: {
        'BurnRequest(bytes32,address,uint256,bytes,bytes,uint256,address)'(
            id?: null,
            from?: string | null,
        ...
        'SynthesizeCompleted(bytes32,address,uint256,uint256,bytes)'(
            id?: BytesLike | null,
            to?: string | null,
            amount?: null,
            bridgingFee?: null,
