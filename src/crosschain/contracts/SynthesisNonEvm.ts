...
export declare namespace MetaRouteStructsNonEvm {
    export type MetaBurnTransactionNonEvmStruct = {
        stableBridgingFee: BigNumberish
        amount: BigNumberish
        syntCaller: string
        finalDexRouter: BytesLike
        sToken: string
        swapCallData: BytesLike
        chain2address: BytesLike
        receiveSide: BytesLike
        oppositeBridge: BytesLike
        revertableAddress: BytesLike
        chainID: BigNumberish
    }

    export type MetaBurnTransactionNonEvmStructOutput = [
        BigNumber,
        BigNumber,
        string,
        string,
...
export interface SynthesisNonEvmInterface extends utils.Interface {
    contractName: 'SynthesisNonEvm'
    functions: {
        'bridge()': FunctionFragment
        'burnSyntheticToken(uint256,address,uint256,bytes32,bytes32,bytes32,bytes32,uint256)': FunctionFragment
        'fabric()': FunctionFragment
        'initialize(address,address,address)': FunctionFragment
        'isTrustedForwarder(address)': FunctionFragment
        'metaBurnSyntheticToken((uint256,uint256,address,bytes32,address,bytes,bytes32,bytes32,bytes32,bytes32,uint256))': FunctionFragment
        'metaMintSyntheticToken((uint256,uint256,bytes32,bytes32,uint256,address,address[],address,bytes,address,bytes))': FunctionFragment
        'metaRouter()': FunctionFragment
        'mintSyntheticToken(uint256,bytes32,bytes32,uint256,uint256,address)': FunctionFragment
        ...
        'revertSynthesizeRequest(uint256,bytes32,bytes32,bytes32,uint256)': FunctionFragment
    ...
    encodeFunctionData(
        ...
        values: [BigNumberish, string, BigNumberish, BytesLike, BytesLike, BytesLike, BytesLike, BigNumberish]
    ): string
    ...
    encodeFunctionData(
        ...
        values: [MetaRouteStructsNonEvm.MetaBurnTransactionNonEvmStruct]
    ): string
    encodeFunctionData(
    ...
    encodeFunctionData(
        ...
        values: [BigNumberish, BytesLike, BytesLike, BigNumberish, BigNumberish, string]
    ): string
    ...
    events: {
        'BurnRequest(bytes32,address,uint256,bytes32,bytes32,uint256,address)': EventFragment
        ...
        'SynthesizeCompleted(bytes32,address,uint256,uint256,bytes32)': EventFragment
    }
...
export interface SynthesisNonEvm extends BaseContract {
    contractName: 'SynthesisNonEvm'
    connect(signerOrProvider: Signer | Provider | string): this
    attach(addressOrName: string): this
    deployed(): Promise<this>

    interface: SynthesisNonEvmInterface
    ...
    functions: {
        ...
        burnSyntheticToken(
            ...
            _chain2address: BytesLike,
            _receiveSide: BytesLike,
            _oppositeBridge: BytesLike,
            _revertableAddress: BytesLike,
        ...
        metaBurnSyntheticToken(
            _metaBurnTransaction: MetaRouteStructsNonEvm.MetaBurnTransactionNonEvmStruct,
            overrides?: Overrides & { from?: string | Promise<string> }
        ): Promise<ContractTransaction>
    ...
    filters: {
        'BurnRequest(bytes32,address,uint256,bytes32,bytes32,uint256,address)'(
            id?: null,
            from?: string | null,
            chainID?: BigNumberish | null,
            revertableAddress?: BytesLike | null,
            to?: null,
            amount?: null,
            token?: null
        ...
        'SynthesizeCompleted(bytes32,address,uint256,uint256,bytes32)'(
            id?: BytesLike | null,
            to?: string | null,
            amount?: null,
            bridgingFee?: null,
