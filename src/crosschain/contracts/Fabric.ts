...
export type RepresentationCreatedEvent = TypedEvent<[string, BigNumber, string], RepresentationCreatedEventObject>
...
export interface Fabric extends BaseContract {
    ...
    functions: {
        ...
        initialize(_synthesis: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    estimateGas: {
        ...
        initialize(_synthesis: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    populateTransaction: {
        ...
        initialize(_synthesis: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
