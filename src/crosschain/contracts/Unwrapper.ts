...
export interface Unwrapper extends BaseContract {
    ...
    functions: {
        ...
        setWrapper(_newWrapper: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    estimateGas: {
        ...
        setWrapper(_newWrapper: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>

        transferOwnership(newOwner: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>

        unwrap(_amountIn: BigNumberish, _to: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    populateTransaction: {
        ...
        setWrapper(_newWrapper: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
