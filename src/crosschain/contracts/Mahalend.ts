...
export interface MahalendInterface extends utils.Interface {
    contractName: 'Mahalend'
    functions: {
...
export type MintedToTreasuryEvent = TypedEvent<[string, BigNumber], { reserve: string; amountMinted: BigNumber }>

export type MintedToTreasuryEventFilter = TypedEventFilter<MintedToTreasuryEvent>

export type RebalanceStableBorrowRateEvent = TypedEvent<[string, string], { reserve: string; user: string }>
...
export type UserEModeSetEvent = TypedEvent<[string, number], { user: string; categoryId: number }>
...
export interface Mahalend extends BaseContract {
    contractName: 'Mahalend'
    connect(signerOrProvider: Signer | Provider | string): this
    attach(addressOrName: string): this
    deployed(): Promise<this>

    interface: MahalendInterface
    ...
    estimateGas: {
        ...
        dropReserve(asset: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
